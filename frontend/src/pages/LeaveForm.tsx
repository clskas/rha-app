    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-lg space-y-5">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
          <button type="button" onClick={() => navigate('/leaves')} className="px-4 py-2 border border-gray-300 rounded-lg text-sm hover:bg-gray-50 w-full sm:w-auto">Annuler</button>
          <button type="submit" disabled={saving} className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-dark disabled:opacity-50 w-full sm:w-auto justify-center">
